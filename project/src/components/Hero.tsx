    ...
    >
      ...
      <div className="container mx-auto px-6 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen">
          <div className="lg:pr-8 relative z-10 transition-all duration-300 ease-out
            pt-32 md:pt-24 lg:pt-0 
            -mt-12 md:mt-0"
          >
            ...
            <p className="text-gray-300 text-lg mb-4 max-w-xl transition-all duration-300
          ...
          <div 
            ref={panelsRef} 
            className="relative h-[400px] md:h-[500px] w-full flex items-center justify-center transition-all duration-700 ease-out
              -mt-16 md:mt-0 lg:mt-0"
            style={{
